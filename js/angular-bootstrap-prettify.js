/*jslint browser:true, vars: true, regexp: true */
/*global define*/

define(['angular', 'prettify'], function (angular, prettify) {
    'use strict';
        ...
        return {
            ...
            compile: function (element) {
                ...
                if (window.RUNNING_IN_NG_TEST_RUNNER) {
                    ...
                    element.html(prettify.prettyPrintOne(reindentCode(html), undefined, true));
                }
            }
        };
    }];
    ...
    return angular.module('bootstrapPrettify', []).directive(directive).factory(service);
});